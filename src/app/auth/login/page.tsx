...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#020202] bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-purple-900/30 via-black to-black p-4Selection">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 relative z-10">
          <div className="space-y-2">
            ...
            <input
              ...
              type="email"
              className={`w-full bg-[#0a0a0a] border ${errors.email ? 'border-red-500/50' : 'border-white/10'} rounded-2xl px-5 py-4 text-zinc-100 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300 backdrop-blur-sm [selection:background-color:rgba(168,85,247,0.4)] autofill:shadow-[0_0_0px_1000px_#0a0a0a_inset] [-webkit-text-fill-color:white]`}
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              type="password"
              className={`w-full bg-[#0a0a0a] border ${errors.password ? 'border-red-500/50' : 'border-white/10'} rounded-2xl px-5 py-4 text-zinc-100 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300 backdrop-blur-sm [selection:background-color:rgba(168,85,247,0.4)] autofill:shadow-[0_0_0px_1000px_#0a0a0a_inset] [-webkit-text-fill-color:white]`}
              placeholder="••••••••"
            />
